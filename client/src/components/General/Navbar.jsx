  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#2D2D2D] z-50 shadow-md">
      <div className="flex items-center justify-between px-8 md:px-16 py-4">
        ...
        <div
          onClick={() => navigate("/")}
          className="w-[100px] h-[45px] bg-gray-200 flex items-center justify-center text-black font-bold text-sm cursor-pointer"
        >
          LOGO
        </div>
        ...
        <button
          ...
          className="hidden md:block bg-[#FF4C24] text-white font-bold px-8 py-2 hover:bg-white hover:text-[#FF4C24] transition-all duration-300 font-bebas tracking-wider"
        >
          REGISTER
        </button>
      ...
      {isOpen && (
        <div className="md:hidden bg-[#1E1E1E] flex flex-col items-center space-y-4 py-6 border-t border-gray-700">
          ...
          <button
            ...
            className="bg-[#FF4C24] text-white font-bold px-6 py-2 rounded-sm hover:bg-white hover:text-[#FF4C24] transition-all duration-300 font-bebas tracking-wider"
          >
            REGISTER
          </button>
        </div>
