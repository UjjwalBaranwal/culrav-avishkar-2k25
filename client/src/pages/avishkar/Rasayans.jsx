      ...
      <div className="max-w-6xl mx-auto px-6 py-14 grid grid-cols-1 sm:grid-cols-2 gap-10">
        {RasayansData.events.map((event) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="relative p-6 border border-cyan-600 rounded-xl bg-black/90 backdrop-blur-md
                       shadow-md cursor-pointer text-center select-none"
      ...
      <AnimatePresence>
        {selected && (
          <motion.div
            ...
            className="fixed top-0 left-0 w-full h-full bg-black/80 backdrop-blur-md z-50 p-8 
                       overflow-y-auto neon-shadow"
