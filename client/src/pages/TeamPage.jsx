        ...
        <div className="flex h-screen w-full pt-[77px] bg-[#0a0a1a] text-white font-Anton">
            ...
            <div className="md:hidden fixed top-[77px] left-0 right-0 z-40 bg-gradient-to-r from-[#0a0a1a] via-[#101020] to-[#0a0a1a] border-b border-[#1a1a3d] shadow-lg">
                <div className="relative p-4">
                    ...
                    <ChevronDown size={20} className="absolute right-7 top-1/2 -translate-y-1/2 text-[#00e5ff] pointer-events-none" />
                </div>
            </div>
                ...
                <div className="p-6 md:p-12 max-w-7xl mx-auto">
                    {teamData.map((team) => (
                        ...
                        >
                            {/* Section Heading */}
                            <motion.h2
                                className="text-4xl font-Anton tracking-widest mb-8 text-cyan-200  relative inline-block"
