...
// === INPUT STYLE ===
const neonInput =
  "w-full px-4 py-2 text-lg  bg-[#050816]/80 border border-cyan-400/70 text-cyan-100 placeholder-cyan-400/40 focus:outline-none focus:border-fuchsia-400 shadow-[0_0_12px_rgba(56,189,248,0.45)]";

// === BUTTON STYLE ===
const buttonClass =
  "mt-2 w-full py-2 bg-gradient-to-r from-cyan-400 via-sky-400 to-fuchsia-500 text-black text-lg font-semibold  hover:brightness-125 transition shadow-[0_0_20px_rgba(236,72,153,0.8)]";

// === SMALL LINK STYLE ===
const smallLinkClass =
  "text-fuchsia-400 cursor-pointer hover:underline hover:text-fuchsia-300 transition mt-1 text-center";
...
const Login = () => {
  ...
  return (
    <div
      ...
      className="flex items-center justify-center min-h-screen bg-[#020617] relative overflow-hidden"
    >
      {/* Background */}
      ...
      {/* CARD */}
      <motion.div
        className="login-card relative w-[380px] max-w-[92vw]   bg-slate-950/60 px-5 py-6 backdrop-blur-xl"
      ...
      >
        ...
        {/* <div className="pointer-events-none absolute inset-0 overflow-hidden ">
          <div className="absolute top-[1px] left-[12px] h-2 w-20 bg-cyan-400  " />
          <div className="absolute top-[1.5px] right-[4px] h-2 w-20 bg-fuchsia-500 " />
          <div className="absolute bottom-[1.5px] right-[4px] h-2 w-20 bg-cyan-400 " />
          <div className="absolute bottom-[1.5px] left-[4px] h-2 w-20 bg-fuchsia-500 " />
        </div>*/}
        <AnimatePresence mode="wait">
          ...
          {view === "register" && (
            <motion.form
              ...
              className="space-y-2"
            >
              <h2 className="text-3xl text-center font-extrabold text-cyan-300 m-4">
                Register 🚀
              </h2>
              ...
              <p className="text-cyan-100 text-lg text-center mt-1">
                Already registered?{" "}
                <span
                  className={smallLinkClass}
          ...
          {view === "login" && (
            <motion.form
              ...
              className="space-y-2"
            >
              <h2 className="text-4xl font-extrabold text-cyan-300 m-4 text-center">
                Welcome Back!!
              </h2>
              ...
              <div className="flex justify-between text-lg text-cyan-100 mt-1">
                <span
                  className={smallLinkClass}
          ...
          {view === "reset" && (
            ...
            >
              ...
              <p className="text-center text-lg text-cyan-100 mt-1">
                <span
                  className={smallLinkClass}
                  onClick={() => setView("login")}
                >
